...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[28px] border border-white/70 bg-white/92 text-card-foreground shadow-card backdrop-blur",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm text-ink-4", className)} {...props} />
))
