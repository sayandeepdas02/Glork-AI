      ...
      <div className="relative">
        <input
          ...
          className={cn(
            ...
            "border-gray-200 hover:border-gray-300 focus:border-[#0A0A0A] focus:ring-2 focus:ring-[#0A0A0A]/8",
            rightSlot && "pr-11",
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        <Link href="/login" className="font-semibold text-[#0A0A0A] underline underline-offset-2 hover:text-[#333] transition-colors">
          Sign in
        </Link>
      </p>
    </form>
