    ...
    <div className="rounded-2xl bg-[#141210] border border-white/6 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
        <div>
          ...
          <p className="text-[11px] font-mono text-white/50 mt-0.5">Next confirmed appointments</p>
        </div>
        <Link
          href="/bookings"
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-14 text-center px-4">
          ...
          <p className="text-xs text-white/55 mt-1 font-mono">Confirmed appointments will appear here</p>
        </div>
      ) : (
        <div className="divide-y divide-white/4">
